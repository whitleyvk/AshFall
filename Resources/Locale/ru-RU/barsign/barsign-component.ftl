...
barsign-prototype-description-the-lightbulb = Кафе, популярное среди луам и людей. Однажды его закрыли на неделю после того, как барменша использовала нафталин для обработки своей запасной униформы.
