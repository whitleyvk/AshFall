humanoid-profile-editor-randomize = Случайные значения
humanoid-profile-editor-randomize-unlocked-button = Случайные незаблокированные значения
...
humanoid-profile-editor-randomize-markings-button = Особенности
...
humanoid-profile-editor-randomizer-lock-tooltip = Не изменять это значение при случайном выборе
...
humanoid-profile-editor-voice-none = Голос без названия
