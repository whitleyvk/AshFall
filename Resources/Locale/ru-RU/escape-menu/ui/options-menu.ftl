...
ui-options-mute-unfocused = Отключать звук, когда окно неактивно
...
ui-options-function-open-targeting-menu = Радиальное меню прицеливания
...
ui-options-accessibility-header-reduced-motion = Снижение движения
...
ui-options-disable-drunk-overlay-tooltip = Заменяет движение в эффекте опьянения статичным смещением.
ui-options-disable-flash-effect = Вспышка
ui-options-disable-flash-effect-tooltip = Заменяет эффект вспышки вариантом с меньшим движением.
ui-options-disable-heat-distortion = Искажение от жара
ui-options-disable-heat-distortion-tooltip = Уменьшает движение в эффекте искажения от жара.
ui-options-disable-nv-noise = Эффект ночного зрения
ui-options-disable-nv-noise-tooltip = Отключает шум в эффекте ночного зрения.
ui-options-disable-rainbow-overlay = Радужный эффект
ui-options-disable-rainbow-overlay-tooltip = Заменяет движение в радужном эффекте статичным смещением.
