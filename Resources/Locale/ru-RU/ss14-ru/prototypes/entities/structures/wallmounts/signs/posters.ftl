...
ent-PosterContrabandMoth = СиндиЛуам — Ядерные операции
    .desc = Плакат, созданный по заказу Синдиката, с использованием СиндиЛуам™, призывающий зрителя держать диск ядерной аутентификации незащищенным. "Мир никогда не был вариантом!" Ни один хороший сотрудник не станет прислушиваться к этой чепухе.
...
ent-PosterLegitCarpMount = Настенный карп
    .desc = Carpe diem!
ent-PosterLegitSafetyMothDelam = Луам-хранитель — Меры безопасности при расслаивании
    .desc = Этот информационный плакат использует Луама-хранителя™, чтобы рассказать читателям о необходимости прятаться в шкафах, если произошло расслоение кристалла суперматерии, чтобы избежать галлюцинаций. Эвакуация может быть лучшей стратегией.
ent-PosterLegitSafetyMothEpi = Луам-хранитель — Эпинефрин
    .desc = Этот информационный плакат использует Луама-хранителя™, чтобы рассказать читателям о необходимости оказания помощи раненым/потерявшим сознание членам экипажа при помощи экстренных медипенов с эпинефрином. "Один простой приём позволит предотвратить гниение органов!"
ent-PosterLegitSafetyMothPiping = Луам-хранитель — Трубопроводы
    .desc = Этот информационный плакат использует Луама-хранителя™, чтобы рассказать атмосферным техникам о правильном выборе типов трубопроводов. "Трубы, не насосы! Правильное размещение труб предотвратит низкую эффективность!"
ent-PosterLegitSafetyMothMeth = Луам-хранитель — Метамфетамин
    .desc = Этот информационный плакат использует Луама-хранителя™, чтобы рассказать читателям о необходимости получения разрешения от главного врача перед началом приготовления метамфетамина. "Держитесь ближе к требуемой для приготовления температуре и никогда не превышайте её!"... Никогда не перегревайте метамфетамин.
ent-PosterLegitSafetyMothHardhat = Луам-хранитель — Защитные каски
    .desc = Этот информационный плакат использует Луама-хранителя™, чтобы рассказать читателям о необходимости использования защитных касок в зонах повышенной опасности. "Это как лампа для головы!"
...
ent-PosterLegitSafetyMothSSD = Луам-хранитель — Космическое расстройство сна
    .desc = Этот информационный плакат использует Луама-хранителя™, чтобы рассказать читателям о Космическом Расстройстве Сна (КРС) — состоянии, при котором член экипажа перестаёт реагировать на происходящее. "Бережно относитесь к членам экипажа с КРС! В любой момент они могут проснуться!"
