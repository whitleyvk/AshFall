...
ent-BarSignTheLightbulb = Лампочка
    .desc = Кафе, популярное среди луам и людей. Однажды его закрыли на неделю после того, как бармен использовала нафталин для обработки своей запасной униформы.
