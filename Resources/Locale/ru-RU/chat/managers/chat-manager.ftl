...
chat-speech-verb-veiru-1 = рычит
chat-speech-verb-veiru-2 = лает
chat-speech-verb-veiru-3 = ворчит
chat-speech-verb-veiru-4 = тявкает
chat-speech-verb-veiru = Вульпканин
