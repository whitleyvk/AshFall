...
lobby-state-soon = Смена скоро начнётся
lobby-state-right-now-question = Прямо сейчас?
lobby-state-right-now-confirmation = Прямо сейчас
lobby-state-round-start-countdown-text = До смены: { $timeLeft }
lobby-state-ready-button-join-state = Приступить
...
lobby-state-player-status-round-not-started = Ожидание смены
lobby-state-player-status-round-time =
    Длительность смены: { $hours } { $hours ->
        [one] час
        [few] часа
        *[other] часов
    } { $minutes } { $minutes ->
