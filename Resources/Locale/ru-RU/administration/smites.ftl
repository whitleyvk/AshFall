...
admin-smite-veiru-species-swap-name = Сделать вейру
...
admin-smite-veiru-species-swap-description = Меняет вид на вейру. Пригодится для тех, кто ведёт себя как космический расист.
