...
using Content.Shared.Ashfall.CCVar;
...
public sealed partial class ParticleSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        _cfg.OnValueChanged(AshfallCCVars.ParticleQuality, OnQualityChanged, invokeImmediately: true);
        _cfg.OnValueChanged(AshfallCCVars.ParticleGlobalBudget, v => _globalBudget = v, invokeImmediately: true);
    }

    public override void Shutdown()
    {
        base.Shutdown();
        _cfg.UnsubValueChanged(AshfallCCVars.ParticleQuality, OnQualityChanged);
