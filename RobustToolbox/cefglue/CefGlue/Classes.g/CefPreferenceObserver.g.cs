...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefPreferenceObserver
    {
        ...
        internal void add_ref(cef_preference_observer_t* self)
        {
            lock (SyncRoot)
            {
                var result = ++_refct;
        ...
        internal int release(cef_preference_observer_t* self)
        {
            lock (SyncRoot)
            {
                var result = --_refct;
        ...
        internal int has_one_ref(cef_preference_observer_t* self)
        {
            lock (SyncRoot) { return _refct == 1 ? 1 : 0; }
        }
        
        internal int has_at_least_one_ref(cef_preference_observer_t* self)
        {
